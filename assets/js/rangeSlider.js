!(function (t) {
  ...
  function (t, e, n) {
    ...
    function l(t, e) {
      for (var n = {}, r = [], i = 0; i < t.length; i++) {
        ...
        -1 !== p
          ? (s[p].references++, s[p].updater(d))
          : s.push({ identifier: c, updater: _(d, e), references: 1 }),
          r.push(c);
      }
      return r;
    }
    ...
    function d(t, e, n, r) {
      ...
      if (t.styleSheet) t.styleSheet.cssText = p(e, i);
        ...
        s[e] && t.removeChild(s[e]),
          s.length ? t.insertBefore(a, s[e]) : t.appendChild(a);
      }
    }
    function f(t, e, n) {
      var r = n.css,
  ...
  function (t, e, n) {
    "use strict";
    Object.defineProperty(e, "__esModule", { value: !0 }),
      (e.defaultModel = { min: 10, max: 50, step: 2, values: [20] });
  },
  function (t, e, n) {
    "use strict";
    Object.defineProperty(e, "__esModule", { value: !0 }),
  ...
  function (t, e, n) {
    ...
    (function (t) {
      ...
      var a = i(n(8)),
        ...
        l = {
          reset: function () {
            ...
            e.model.setState(t(this).data().startingModel),
              e.reCreateApplication(t(this).data().startingVisualModel);
          },
          destroy: function () {
            t(this).data("rangeSlider").app.removeHTML(),
              t(this).off("onChange");
          },
          onChange: function (e) {
      ...
      function u(e, n) {
        void 0 === e && (e = o.defaultVisualModel),
          void 0 === n && (n = s.defaultModel);
        var i = r(r({}, o.defaultVisualModel), e),
          l = r(r({}, s.defaultModel), n);
        return this.each(function () {
          (t(this).data().rangeSlider = new a.default(this, i, l)),
            (t(this).data().startingVisualModel = i),
            (t(this).data().startingModel = l);
        });
      }
      function c(e) {
        var n = e.VisualState,
        ...
        i.model.setState(r),
          i.reCreateApplication(Object.assign(i.visualModel.state, n));
      }
      t.fn.rangeSlider = function (e, n) {
        if (
          (t(this).data("rangeSlider") || u.call(this), "string" == typeof e)
        ) {
          if ("onChange" === e && "function" == typeof n)
            return l[e].call(this, n);
          if (l[e] && "onChange" !== e) return l[e].call(this);
        }
        if ("object" == typeof e)
          return c.call(this, { VisualState: e, ModelState: n || {} });
      };
    }).call(this, n(7));
  },
  function (t, e) {
      ...
      l = (function () {
        function t(t, e, n) {
          (this.anchor = t),
            ...
            (this.app = new o.default().main(
              this.visualModel.state,
              this.anchor
            )),
            ...
            this.app.on("finishInit", function (e) {
              ...
              this.app.UIs.settings &&
                this.app.UIs.settings.on("newSettings", function (e) {
                  t.model.setState(e),
                    t.arrangeHandles(e),
                    e.step && t.reCreateApplication();
                }),
              this.model.on("pxValueDone", function () {
                return (
                  t.app.UIs.settings &&
                  t.app.UIs.settings.setState(
                    t.model.state,
                    t.visualModel.state
                  )
                );
              ...
              this.model.on("pxValueDone", function () {
                return t.anchor.dispatchEvent(
                  new CustomEvent("onChange", { detail: t.model.state })
                );
              }),
              this.app.UIs.scale &&
    ...
    var o = s(n(1)),
      ...
      u = (function (t) {
        function e(e) {
          ...
          return (
            (n.state = l.defaultModel),
            (n.mapOfHandles = new Map()),
            (n.edge = 0),
            n.setState(e),
            n
          );
        ...
        return (
          ...
          (e.prototype.counting = function (t) {
            ...
            this.mapOfHandles.set(r, { value: e, pxValue: n }),
              void 0 === t.value &&
                (this.state = a(a({}, this.state), this.updateArrayOfValues())),
              this.notifyAboutPxValueDone({ value: e, pxValue: n, target: r });
          }),
          (e.prototype.findViewValue = function (t) {
            ...
            return (
              void 0 !== t.value
                ? (e = t.value)
                : void 0 !== t.left && (e = this.countValueFromLeft(t.left)),
              e
            );
          }),
          (e.prototype.updateArrayOfValues = function () {
            for (
              var t = [], e = 0, n = Array.from(this.mapOfHandles.values());
              e < n.length;
              e++
            ) {
              var r = n[e];
          ...
          (e.prototype.createSteps = function () {
            var t = this,
              ...
              s = new Set([n, r]);
            if (a >= 15)
              for (var o = 0.2 * (r - n), l = n; l <= r; l += o)
                s.add(this.correctValueInTheRange(l));
        ...
        return (
          (t.prototype.main = function (t, e) {
            ...
            if (r === s.constants.TYPE_SINGLE) n = new a.SingleFactory(o);
              ...
              if (r !== s.constants.TYPE_INTERVAL)
                throw new Error("Error! Unknown " + r + " or " + o);
      ...
      c = (function (t) {
        function e(e, n) {
          ...
          return (
            ...
            (r.anchor = n),
            (r.UIs = {}),
            (r.template = new o.default()),
            (r.closestHandle = null),
            r
          );
        }
        return (
          ...
          (e.prototype.init = function (t) {
            ...
            this.bindEventListeners({ wrapper: r, state: t }),
              this.emit("finishInit", { handles: n, edge: e });
          }),
          ...
          (e.prototype.getEdge = function (t) {
            ...
            if (!this.anchor.querySelectorAll(".slider__handle"))
              throw new Error(".slider__handle - не было найдено!");
            return t.direction === u.constants.DIRECTION_VERTICAL
              ? e.clientHeight
              : e.offsetWidth;
          }),
          (e.prototype.bindEventListeners = function (t) {
            t.wrapper.addEventListener(
              "mousedown",
              this.handleStartMove.bind(this, t)
            );
          }),
          (e.prototype.handleStartMove = function (t, e) {
            ...
            var r = e.target;
            if (
              r.className.match(/(slider__handle|slider__tip|slider__bar)/g)
            ) {
              if (
                (r.className.includes("slider__tip") && (r = r.parentElement),
                !r)
              )
                throw new Error("event.target - не найден!");
              var i = {
                  shiftX: e.offsetX,
          ...
          (e.prototype.handleMouseMove = function (t, e) {
            ...
            if (
              ((n =
                o.state.direction === u.constants.DIRECTION_VERTICAL
                  ? o.wrapper.offsetHeight -
                    e.clientY -
                    a +
                    o.wrapper.getBoundingClientRect().top
                  : e.clientX - s - o.wrapper.offsetLeft),
              i && !this.closestHandle)
            ) {
              var l = Array.from(
                o.wrapper.querySelectorAll(".slider__handle")
              ).map(function (t) {
                return {
                  value:
                    o.state.direction === u.constants.DIRECTION_VERTICAL
                      ? parseInt(t.style.bottom || "")
              ...
              if (2 === l.length) {
                var c = [
                  Math.abs(l[0].value - n),
                  Math.abs(l[1].value - n),
                ].map(function (t, e, n) {
      ...
      d = (function (t) {
        ...
        return (
          ...
          (e.prototype.setState = function (t, e) {
            return (
              (this.model = a(a({}, this.model), t)),
              (this.visualModel = a(a({}, this.visualModel), e)),
              this.paint(),
              this
            );
          }),
          (e.prototype.paint = function () {
            ...
            for (var o = 0, l = Array.from(n); o < l.length; o++) {
              ...
              (c.value = t[c.name]),
                "valueFrom" === c.name &&
                  ((c.step = t.step), (c.min = t.min), (c.max = t.max)),
                "valueTo" === c.name &&
                  ((c.step = t.step), (c.min = t.min), (c.max = t.max));
            }
            for (
              var p = this.wrapper.querySelectorAll("select"),
                d = 0,
                f = Array.from(p);
              d < f.length;
              d++
          ...
          (e.prototype.handleChangeSettings = function (t) {
            ...
            if ("INPUT" === r.tagName) {
              ...
              if ("valueFrom" === r.name || "valueTo" === r.name) {
                ...
                this.emit(
                  "newSettings",
                  (((e = { handles: i, edge: this.state.edge })[r.name] =
                    Number(r.value)),
                  e)
                );
              ...
              var o = r,
                l = void 0;
              (l =
                "true" === o.value || "false" === o.value
                  ? JSON.parse(o.value)
                  : o.value),
                this.emit("reCreateApp", (((n = {})[r.name] = l), n));
            }
          }),
          e
        );
      ...
      return (
        (t.prototype.init = function (t, e) {
          var n = t.skin,
            r = t.direction,
            i =
              '\n      <div class="wrapper-slider wrapper-slider--' +
              r +
          ...
          e.insertAdjacentHTML("afterbegin", i),
            (this.wrapper = e.querySelector(".wrapper-slider"));
        }),
        t
      );
    })();
      ...
      return (
        (t.prototype.init = function (t) {
          t.insertAdjacentHTML(
            "beforeend",
            '<div class="slider__tip"><div class="slider__tongue"></div></div>'
          );
        }),
        t
      );
      ...
      return (
        ...
        (e.prototype.paint = function (t) {
          ...
          if (e && r) {
            ...
            var s =
                e.parentElement &&
                e.parentElement.querySelectorAll(".slider__tip"),
              o =
                s &&
            ...
            if (o) {
              ...
              l <= o.offsetWidth && l <= a.offsetWidth
                ? (a.classList.contains("slider__tip--extended") &&
                    (a.classList.remove("slider__tip--extended"),
                    o.classList.remove("slider__tip--extended"),
      ...
      return (
        ...
        (e.prototype.paint = function (t) {
          ...
          if (void 0 === e || void 0 === n)
            throw new Error("pxValue или target не был передан!");
          var r =
            n.parentElement && n.parentElement.querySelector(".slider__bar");
          if (!r) throw new Error(".slider__bar - не было найдено!");
          this.direction === a.constants.DIRECTION_HORIZONTAL
            ? (r.style.width = e + 10 + "px")
            : this.direction === a.constants.DIRECTION_VERTICAL &&
              (r.style.height = e + 10 + "px");
        }),
        e
      );
    })(s);
      ...
      return (
        ...
        (e.prototype.paint = function (t) {
          var e = t.pxValues,
            n = t.target;
          if (void 0 === e || void 0 === n)
            throw new Error("pxValues или target не был передан!");
          var r =
            n.parentElement && n.parentElement.querySelector(".slider__bar");
          if (!r) throw new Error(".slider__bar - не было найдено!");
          this.direction === a.constants.DIRECTION_HORIZONTAL
            ? ((r.style.left = e[0] + "px"),
              (r.style.width = e[1] - e[0] + 10 + "px"))
            : this.direction === a.constants.DIRECTION_VERTICAL &&
              ((r.style.bottom = e[0] + "px"),
              (r.style.height = e[1] - e[0] + 10 + "px"));
        }),
        e
      );
    })(s);
      ...
      s = (function () {
        ...
        return (
          (t.prototype.append = function (t) {
            for (
              var e = this.anchor.querySelectorAll(".slider__handle"),
                n = 0,
                r = Array.from(e);
              n < r.length;
              n++
    ...
    var s = a(n(1)),
      ...
      l = (function (t) {
        function e(e, n) {
          ...
          (r.direction = e),
            (r.anchor = n),
            (r.steps = [{ value: 0, px: 0 }]),
            (r.handleScaleValue = r.handleScaleValue.bind(r)),
            (r.slider = n.querySelector(".slider"));
          return (
            r.slider.insertAdjacentHTML(
              "afterbegin",
              '<div class="slider__scale"><div class="scale"></div></div>'
            ),
            (r.wrapper = r.anchor.querySelector(".scale")),
            r.wrapper.addEventListener("click", r.handleScaleValue),
            r
          );
        }
        return (
          ...
          (e.prototype.findClosestHandle = function (t, e) {
            ...
            2 === n.length
              ? (i[
                  [Math.abs(i[0] - e), Math.abs(i[1] - e)].map(function (
                    t,
                    e,
                    n
                  ) {
